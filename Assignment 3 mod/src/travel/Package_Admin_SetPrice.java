...
public class Package_Admin_SetPrice extends JFrame {
	...
	public Package_Admin_SetPrice() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Package_Admin_SetPrice.class.getResource("/icon_pics/small-axe.png"))); //contructor without argument
		...
		btnUpload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					try {
					File file = new File("C:\\USERS\\USER\\eclipse-workspace\\Assignment 3 mod\\src\\textFiles\\New_Price_Rate.txt");
					if(!file.exists()) {
						file.createNewFile();
						}
