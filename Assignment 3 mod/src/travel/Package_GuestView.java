...
public class Package_GuestView extends JFrame {
	...
	public Package_GuestView() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Package_GuestView.class.getResource("/icon_pics/small-axe.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Package_GuestView.class.getResource("/icon_pics/giveaway_a1.png")));
